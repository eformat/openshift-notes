...
router-internal-default         ClusterIP   172.30.53.118    <none>        80/TCP,443/TCP,1936/TCP   5d2h
router-internal-red-dmz-shard   ClusterIP   172.30.217.154   <none>        80/TCP,443/TCP,1936/TCP   4d18h

oc get svc -n welcome
NAME      TYPE        CLUSTER-IP       EXTERNAL-IP   PORT(S)    AGE
welcome   ClusterIP   172.30.146.141   <none>        8080/TCP   3m47s
...
curl -H 'Host: welcome-welcome.apps.foo.eformat.me' 172.30.217.154
